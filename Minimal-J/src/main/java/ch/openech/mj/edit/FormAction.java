...
public abstract class FormAction<T> {
	...
	protected T newInstance() {
		...
		Class<T> clazz = (Class<T>) ch.openech.mj.util.GenericUtils.getGenericClass(FormAction.this.getClass());
	...
	private class EditorChangeListener implements IForm.FormChangeListener<T> {
		...
		public void validate(T object, List<ValidationMessage> validationResult) {
			FormAction.this.validate(object, validationResult);
		}
